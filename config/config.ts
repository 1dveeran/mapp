          ...
          routes: [
            ...
            },
            {
              ...
              routes: [
                ...
                {
                  name: 'list-patients',
                  path: '/patients/list-patients',
                  component: './patients/list-patients',
                },
                {
                  name: 'diagnose-patients',
                  path: '/patients/diagnose-patients',
                  component: './patients/diagnose-patients',
                },
                {
                  name: 'patients-symptoms',
                  path: 'patients/patients-symptoms',
