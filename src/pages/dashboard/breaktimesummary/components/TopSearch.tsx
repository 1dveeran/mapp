...
const columns = [
  ...
  },
  {
    title: (
      <FormattedMessage
        id="dashboard-analysis.table.search-key"
  ...
  {
    title: <FormattedMessage id="dashboard-analysis.table.us" defaultMessage="Department"/>,
    dataIndex: 'count',
    key: 'count',
  ...
  {
    title: (
      <FormattedMessage id="dashboard-analysis.table.weekly-r" defaultMessage="Total Hours"/>
    ),
    dataIndex: 'range',
    key: 'range',
...
const TopSearch = ({
  ...
  <Card
    ...
    title={
      <FormattedMessage
        id="dashboard-analysis.analysis.online-top-sea"
