...
const SalesCard = ({
  ...
  <Card loading={loading} bordered={false} bodyStyle={{padding: 0}}>
    <div className={styles.salesCard}>
      ...
      >
        <TabPane
          tab={<FormattedMessage id="dashboard-analysis.analysis" defaultMessage="Users"/>}
          key="sales"
        >
          <Row type="flex">
            <Col xl={16} lg={12} md={12} sm={24} xs={24}>
              <div className={styles.salesBar}>
                <Bar
                  ...
                  title={
                    <FormattedMessage
                      id="dashboard-analysis.analysis"
                      defaultMessage="Department Break Trend in Hrs"
                    />
                  }
                  data={salesData}
                />
            ...
            <Col xl={8} lg={12} md={12} sm={24} xs={24}>
              <div className={styles.salesRank}>
                <h4 className={styles.rankingTitle}>
                  <FormattedMessage
                    id="dashboard-analysis.analysis.sal"
                    defaultMessage="Department Ranking"
                  />
                </h4>
